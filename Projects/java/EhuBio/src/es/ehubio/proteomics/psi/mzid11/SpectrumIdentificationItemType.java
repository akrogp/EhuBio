    ...
    extends IdentifiableType
{
    ...
    protected List<PeptideEvidenceRefType> peptideEvidenceReves;
    ...
    /**
     * Gets the value of the peptideEvidenceReves property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the peptideEvidenceReves property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPeptideEvidenceReves().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PeptideEvidenceRefType> getPeptideEvidenceReves() {
        if (peptideEvidenceReves == null) {
            peptideEvidenceReves = new ArrayList<PeptideEvidenceRefType>();
        }
        return this.peptideEvidenceReves;
    }
