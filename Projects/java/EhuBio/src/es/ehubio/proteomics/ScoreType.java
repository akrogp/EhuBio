...
public enum ScoreType {	
	...
	SEQUEST_DELTACN("MS:1001156","SEQUEST:deltacn","The SEQUEST result 'DeltaCn'",true),
	SEQUEST_SPRANK("MS:1002249","SEQUEST:sprank","The SEQUEST result 'SpRank'",false),
	SEQUEST_SPSCORE("MS:1002248","SEQUEST:spscore","The SEQUEST result 'SpScore'",true),
	SEQUEST_TOTAL_IONS("MS:1001162","SEQUEST:total ions","The SEQUEST result 'Total Ions'",true),
	SEQUEST_MATCHED_IONS("MS:1001161","SEQUEST:matched ions","The SEQUEST result 'Matched Ions'",true),
	SEQUEST_EVALUE("MS:1001159","SEQUEST:expectation value","The SEQUEST result 'Expectation value'",false),
	...
	EVALUE(null,"e-value","Expectation value",false),
